...
# current speed and travelled distance. Add a class initializer that sets the first two of the properties
# based on parameter values. The current speed and travelled distance of a new car must be automatically set to zero.
